...
$sql="update  tblclasses set ClassName=:classname,Slot=:slot where id=:cid ";
...
{   ?>
                                                    ...
                                                    <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                                            ...
                                                            <span class="help-block">Eg- Third, Fouth etc</span>
                                                		</div>
                                                	</div>
                                                       
                                                     <div class="form-group has-success">
                                                        <label for="success" class="control-label">Slot</label>
                                                        <div class="">
                                                            <input type="text" name="section" value="<?php echo htmlentities($result->Slot);?>" class="form-control" required="required" id="success">
                                                            <span class="help-block">Eg- A1,B2,C2 etc</span>
                                                        </div>
                                                    </div>
                                                    <?php }} ?>
  <div class="form-group has-success">
