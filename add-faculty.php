...
if(strlen($_SESSION['alogin']) == "") {
    ...
    if(isset($_POST['submit'])) {
        $facultyName = $_POST['fullanme']; // Corrected field name
        $RollId = $_POST['rollid']; // Corrected field name
        $facultyEmail = $_POST['emailid']; // Corrected field name
        $Gender = $_POST['gender']; // Corrected field name
        $DOB = $_POST['dob']; // Corrected field name
        $Status = 1; // Assuming default status is active

        $sql = "INSERT INTO tblfaculty (facultyName, RollId, facultyEmail, Gender, DOB, Status) 
                VALUES (:facultyName, :RollId, :facultyEmail, :Gender, :DOB, :Status)";
...
<html lang="en">
    <head>
        ...
        <title>SMS Admin| Faculty Admission< </title>
