...
if(strlen($_SESSION['alogin'])=="") {   
    ...
    if(isset($_POST['submit'])) {
        ...
        // Prepare SQL query
        $sql = "INSERT INTO tblclasses(ClassName, Slot) VALUES(:classname, :slot)";
                                            ...
                                            <form method="post">
                                                <div class="form-group has-success">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span class="help-block">Eg- Third, Fourth, etc.</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group has-success">
                                                    ...
                                                    <div>
                                                        <input type="text" name="slot" class="form-control" required="required" id="slot">
                                                        <span class="help-block">Eg- A1, B1, C1, etc.</span>
                                                    </div>
                                                </div>
