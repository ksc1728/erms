                        ...
                        <div class="panel login-box">
                            <div class="panel-heading">
                                <div class="panel-title text-center">
                                    <h4>Exam and Result Management System</h4>
                                </div>
                            </div>
...
{   ?>
<option value="<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->ClassName); ?>&nbsp; Slot-<?php echo htmlentities($result->Slot); ?></option>
<?php }} ?>
 </select>
</div>
                        ...
                        <!-- /.panel -->
                        <p class="text-muted text-center"><small>created by <a href="#">team</a></p>
                    </div>
